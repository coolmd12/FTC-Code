/*
In this program, I made a code that when you do a certain thing, it gives you
an output in the telemetry of the driver station
 */
...
public class GamePadPractice extends OpMode {
    ...
    public void loop() {
        //runs 50x* a second
        double speedForward = -gamepad1.left_stick_y / 2.0; // The "/ 2.0" makes the robot drive at half the range/power
